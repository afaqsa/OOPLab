...
public class P1 {
    public static void main(String[] args) {
        ...
        if(charater.length()>1){
            System.out.println("Error!! you Enter a String not a charater.");
        }
        else if(!(Chara>=65 && Chara <=90) && !(Chara >=97 && Chara <=122)){
            System.out.println("Erorr!! you not enter any alphabet...");
        }
            ...
            System.out.println("The charater you enter it's a Constant.");
        }
    }
